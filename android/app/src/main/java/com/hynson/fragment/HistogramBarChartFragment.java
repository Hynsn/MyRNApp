...
import com.hynson.chart.BaseChartView;
import com.hynson.chart.HistogramBarChartView;
import com.hynson.demo.R;
...
public class HistogramBarChartFragment extends Fragment {
    ...
    private List<BaseChartView.DataBean> getYearData() {
        ...
        datas4.add(new BaseChartView.DataBean("2017-01-01 16:17:00", 240f, 0f, true));
